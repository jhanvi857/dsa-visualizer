...
function Home() {
  ...
  return (
    ...
    <div className="flex flex-col lg:gap-x-20 px-16 mt-4 w-full">
        ...
        <hr />
        {/* <!-- Algorithms... --> */}
      <div className="flex flex-col items-center lg:gap-x-20 px-4 md:px-16 mt-8 w-full" id="algorithms">
      <h1 className="text-white text-4xl text-center mb-8 font-semibold">
        Algorithms
      </h1>
      ...
      <div className="flex justify-center items-center h-16">
        ...
        <hr />
        {/* <!-- classical questions... --> */}
        <h1 className=" text-4xl text-center font-semibold">classical questions</h1>
        <div className="flex flex-col lg:gap-x-20 px-16 mt-8 w-full gap-6 ">
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-x-6 gap-y-8">
            <div className="bg-white/20 p-8 rounded-lg shadow-md shadow-cyan-500/50 transition transform duration-300 ease-in-out hover:scale-105 hover:-translate-y-1 hover:shadow-lg">
              <button className="hover:cursor-pointer text-xl md:text-2xl  font-semibold text-center">
                Maximum subarray sum
              </button>
            </div>
            <div className="text-center bg-white/20 p-8 rounded-lg shadow-md shadow-cyan-500/50 transition transform duration-300 ease-in-out hover:scale-105 hover:-translate-y-1 hover:shadow-lg">
              <a className="text-xl md:text-2xl  font-semibold text-center" href="">
